        ...
        <Container>
            <div className="row row-content">
                ...
                <div className="col-12 col-sm-4 offset-sm-1">
                        ...
                        <i className="fa fa-envelope"></i>: <Link to="mailto:confusion@food.net">confusion@food.net</Link>
                        </address>
                </div>
                ...
                <div className="col-12 col-sm-11 offset-sm-1">
                    <div className="btn-group" role="group">
                        ...
                        <Link role="button" className="btn btn-info"><i className="fa fa-skype"></i> Skype</Link>
